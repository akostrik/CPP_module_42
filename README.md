...
binary    	                                 | formula                                          | decimal                                                                                                        | pr |
---------------------------------------------|--------------------------------------------------|----------------------------------------------------------------------------------------------------------------|----|
s&nbsp;eeeeeeee&nbsp;mmmmmmmmmmmm...m        | $(-1)^{s} * 1.(m)                 * 2^e        $ |                                                                                                                |
s&nbsp;eeeeeeee&nbsp;1mmmmmmmmmmm...m        | $(-1)^{s} * 1.(m)                 * 2^e        $ |                                                                                                                | нормализованные: 1 ≤ мантисса < 10 
s&nbsp;eeeeeeee&nbsp;0mmmmmmmmmmm...m        | $(-1)^{s} * 1.(m)                 * 2^e        $ |                                                                                                                | денормализованные: мантисса с 0, порядок минимальный, они ближе к 0, чем наименьшее представимое нормализованное
...
0&nbsp;00000000&nbsp;00000000000000000000001 | $(-1)^0   * (2^{-23})             * 2^{-126}   $ | 1.40129846432481707092372958328991613128026194187651577175706828388979108268586060148663818836212158203125E-45 | smallest positive denormalized
0&nbsp;00000001&nbsp;11111111111111111111101 |                                                  | 1.175494351e-38 (?)                                                                                            | smallest normalized (without losing precision) 
0&nbsp;00000000&nbsp;00000000000000000000000 | $(-1)^0   * 1.0                   * 2^{-126}$    |                                                                                                                | min positive
0&nbsp;01111101&nbsp;00000000000000000000000 | $(-1)^0   * 1.0                   * 2^{-2}     $ | 0.25                                                                                                           | 
0&nbsp;01111110&nbsp;00000000000000000000000 | $(-1)^0   * 1.0                   * 2^{-1}     $ | 0.5                                                                                                            | 
0&nbsp;01111111&nbsp;00000000000000000000000 | $(-1)^0   * 1.0                   * 2^0        $ | 1.0                                                                                                            | 
0&nbsp;10000000&nbsp;00000000000000000000000 | $(-1)^0   * 1.0                   * 2^1        $ | 2.0                                                                                                            | 
0&nbsp;10000000&nbsp;10000000000000000000000 | $(-1)^0   * 1.5                   * 2^1        $ | 3.0                                                                                                            |
0&nbsp;10000001&nbsp;00000000000000000000000 | $(-1)^0   * 1.0                   * 2^2        $ | 4.0                                                                                                            |
0&nbsp;10000001&nbsp;01000000000000000000000 | $(-1)^0   * 1.25                  * 2^2        $ | 5.0                                                                                                            |
0&nbsp;10000001&nbsp;10000000000000000000000 | $(-1)^0   * 1.5                   * 2^2        $ | 6.0                                                                                                            |
0&nbsp;10000001&nbsp;11000000000000000000000 | $(-1)^0   * 1.75                  * 2^2        $ | 7.0                                                                                                            |
0&nbsp;10000010&nbsp;00000000000000000000000 | $(-1)^0   * 1.0                   * 2^3        $ | 8.0                                                                                                            |
0&nbsp;10000000&nbsp;10010001111010111000011 | $(-1)^0   * 1.5700000524520874    * 2^1        $ | 3.14                                                                                                           | $\frac{3,14 - 2 }{4 - 2} *2^{23}$, 3.14 ∊ [ $2^1$ ; $2^2$ ), $2^7$ 
0&nbsp;11111110&nbsp;11111111111111111111111 | $(-1)^0   * 1+ (2^{23}−1)/ 2^{23} * 2^{254−127}$ | 340282346638528859811704183484516925440                                                                        | maximum normal 
