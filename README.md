...
deque                   |[ ] at front back assign push_back push_front pop_back pop_front insert erase swap clear emplace emplace_front emplace_back                                             |efficient access, insertion 1st and last, no garantee contiguous storage, efficient with long sequences where reallocations is expensive
...
priority_queue (heap)   | top (the largest element O(1)) push emplace pop swap                                                                                                                   |самый большойвсегда в верхней позиции, insertion/ extraction O(ln n) 
