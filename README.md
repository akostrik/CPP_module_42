...
- m mantissa specifying the actual digits of the number ∊ [1;10)
 ...
 | Decimal	                         | e                            | m   |                                                            |
---------------------------------|------------------------------|-----|-----------------------------------------------------------------|
s&nbsp;eeeeeeee&nbsp;mmmmmmmmmmmmmmmmmmmmmmm| ${(-1)}^{s}$ * 1.(mantissa bits) * $2^e$ |                      |     |                     |
...
0 10000000 10010001111010111000011 | 3.14                             | ∊ [ $2^1$ ; $2^2$ ) => $2^7$ | $\frac{3,14 -2 }{4 - 2} *2^{23}$ | 
0 10001001 00110100100110111010100 | 1234.4321                        |                              |     | 
0 00000001 00000000000000000000000 | 1.175494351e-38 smallest without losing precision |             |     | 
...
0 01101000 00000000001011001110001 | 1.1929093e-7 the smallest x : 1+x > 1 |                         |     |
 | The smallest positive denormal number $(-1)^0$ × (1 × $2^{-23}$) × $2^{-126}$ | | |
0 11111110 11111111111111111111111 | Largest $2^{254−127}$ *(1+ ($2^{23}$−1)/ $2^{23}$) = 340282346638528859811704183484516925440 |  |  |    
0 11111111 00000000000000000000000 | +inf                             |                              |     | 
1 11111111 00000000000000000000000 | -inf                             |                              |     | 
0 11111111 10000000000000000000000 | +NaN                             |                              | ~0~ | 
