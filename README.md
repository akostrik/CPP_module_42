...
* экспонента хранится в форме без знака => она смещена на половину своего возможного значения (на 127), поэтому в таблице везде -127
* Как определить, можно ли его представить во float? C числами размером до 23 бит я разобрался: они полностью влезают в мантиссу размером 23 бита
* n ∈ [0;$2^{24}$] точно
...
0&nbsp;10011110&nbsp;00000000000000000000000 | $1.0                   * 2^{158-127}           $| 2147483647, actually stored in float: 2147483648
