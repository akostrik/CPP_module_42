...
binary    	                                | f                                          | decimal                                 | pr                                     |
--------------------------------------------|--------------------------------------------|-----------------------------------------|----------------------------------------|
s&nbsp;eeeeeeee&nbsp;mmmmmmmmmmmmmmmmmmmmmmm| $(-1)^{s}$ * 1.(mmm) * $2^e$               |                                         |                                        |
...
0 11111110 11111111111111111111111          | $2^{254−127}$ *(1+ ($2^{23}$−1)/ $2^{23}$) | 340282346638528859811704183484516925440 | the largest     
